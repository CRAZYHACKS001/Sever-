...
ORIGINAL_BGMI_PATH = '/workspaces/Ddos/bgmi'      #ADD YOUR FILES PATH HERE 
ORIGINAL_SAHIL_PATH = '/workspaces/Ddos/bgmi2'    #ADD YOUR FILES PATH HERE 
...
ADMIN_IDS = set(config['6868412487'])
...
# SCRIPT MADE BY sahil ON TELEGRAM THIS IS A PAID SCRIPT MOST POWERFULL A DDOS TELEGRAM BOT SCRIPT
